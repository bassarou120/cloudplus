...
--
-- Hôte : srv-captain--mysql-serveur-db
-- Généré le : lun. 04 sep. 2023 à 09:08
...
(1, 'Super Admin', 'admin@cloudplus.com', '+229.65653468', '{\"address\":\"Abomey calavi\",\"state\":\"Atlantique\",\"zip\":\"BP 034\",\"country\":\"BJ\",\"city\":\"Abomey calavi\"}', 'admin', NULL, '6238276ac25d11647847274.png', '$2y$10$N7p/vTi/Jr3KO2ed0UCLbOgNU/rENyrSmidpMoOT6rsaidV870DEi', 'jIBIfStzqarH8A8nsLFBfErOvBydXoBb7ftk2GQtOLjFSSHmzTvjtdXWNP7j', NULL, '2023-08-31 16:23:12');
...
(1, 0, 1, 'New member registered', 0, '/admin/clients/detail/1', '2023-09-01 03:49:27', '2023-09-01 03:49:27'),
(2, 0, 1, 'Payment from zimesongbian', 0, '/admin/order/details/1', '2023-09-03 04:18:49', '2023-09-03 04:18:49'),
(3, 0, 0, 'SMS Error: unexpected response from API', 0, '#', '2023-09-03 04:18:50', '2023-09-03 04:18:50');
...
--
-- Structure de la table `billing_settings`
--
...
--
-- Déchargement des données de la table `billing_settings`
--
...
--
-- Structure de la table `cancel_requests`
--
...
--
-- Structure de la table `configurable_groups`
--
...
--
-- Déchargement des données de la table `configurable_groups`
--

INSERT INTO `configurable_groups` (`id`, `name`, `description`, `status`, `created_at`, `updated_at`) VALUES
(1, 'STOCKAGE TYPE NEW', 'Vous pouvez maintenant choisir entre NVMe et SSD pour votre Instance VPS.', 1, '2023-09-02 00:27:58', '2023-09-02 04:33:18'),
(2, 'DESKTOP REMOTE', 'Accédez à des bureaux distants et à des applications professionnelles depuis n\'importe quel endroit et n\'importe quel appareil.', 1, '2023-09-02 06:05:51', '2023-09-02 06:05:51'),
(3, 'PaaS', 'Platform as a service', 1, '2023-09-03 03:04:16', '2023-09-03 03:04:16');

-- --------------------------------------------------------

--
-- Structure de la table `configurable_group_options`
--
...
--
-- Déchargement des données de la table `configurable_group_options`
--

INSERT INTO `configurable_group_options` (`id`, `option_type`, `configurable_group_id`, `name`, `order`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 'STOCKAGE TYPE', 1, 1, '2023-09-02 00:28:32', '2023-09-02 04:27:03'),
(2, 1, 1, 'Add-Ons', 3, 1, '2023-09-02 04:10:35', '2023-09-02 04:52:30'),
(3, 1, 1, 'IMAGE', 2, 1, '2023-09-02 04:10:57', '2023-09-02 04:32:18'),
(4, 1, 1, 'SSL', 4, 1, '2023-09-02 04:11:23', '2023-09-02 04:58:12'),
(5, 1, 2, 'ENTREPRISE', 1, 1, '2023-09-02 06:07:05', '2023-09-02 06:07:05'),
(6, 1, 3, 'Processeur', 1, 1, '2023-09-03 03:04:35', '2023-09-03 03:10:24');

-- --------------------------------------------------------

--
-- Structure de la table `configurable_group_sub_options`
--
...
--
-- Déchargement des données de la table `configurable_group_sub_options`
--

INSERT INTO `configurable_group_sub_options` (`id`, `configurable_group_id`, `configurable_group_option_id`, `name`, `order`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 1, '200 GB SSD', 1, 1, '2023-09-02 00:30:13', '2023-09-02 04:18:55'),
(2, 1, 1, '400 GB SSD', 2, 1, '2023-09-02 04:24:15', '2023-09-02 04:24:15'),
(3, 1, 1, '50 GB NVMe', 3, 1, '2023-09-02 04:26:04', '2023-09-02 04:26:04'),
(4, 1, 1, '100 GB NVMe', 4, 1, '2023-09-02 04:26:33', '2023-09-02 04:26:33'),
(5, 1, 3, 'Ubuntu', 1, 1, '2023-09-02 04:48:12', '2023-09-02 04:48:12'),
(6, 1, 3, 'Windows Server', 2, 1, '2023-09-02 04:48:39', '2023-09-02 04:48:39'),
(7, 1, 3, 'cPanel', 3, 1, '2023-09-02 04:49:03', '2023-09-02 04:49:03'),
(8, 1, 3, 'Cent OS', 4, 1, '2023-09-02 04:49:33', '2023-09-02 04:49:33'),
(9, 1, 3, 'Plesk + Linux', 5, 1, '2023-09-02 04:50:14', '2023-09-02 04:50:14'),
(10, 1, 2, 'Backup-100 GB FTP stockage', 1, 1, '2023-09-02 04:54:38', '2023-09-02 04:54:38'),
(11, 1, 2, 'Backup-500 GB FTP stockage', 2, 1, '2023-09-02 04:55:30', '2023-09-02 04:55:30'),
(12, 1, 2, 'Backup- 1 TB stockage', 3, 1, '2023-09-02 04:56:01', '2023-09-02 04:56:01'),
(13, 1, 4, 'SSL- INTEGRATION', 0, 1, '2023-09-02 04:58:50', '2023-09-02 04:58:50'),
(14, 1, 4, 'Non - Merci', 2, 1, '2023-09-02 04:59:47', '2023-09-02 05:00:35'),
(15, 1, 3, 'Non - Merci', 0, 1, '2023-09-02 05:01:00', '2023-09-02 05:01:00'),
(16, 1, 2, 'Non - Merci', 0, 1, '2023-09-02 05:01:25', '2023-09-02 05:01:25'),
(17, 3, 6, '2 vCPU prod (1 vCPU Staging)', 1, 1, '2023-09-03 03:05:19', '2023-09-03 03:05:19'),
(18, 3, 6, '4 vCPU prod (2 vCPU Staging)', 2, 1, '2023-09-03 03:05:43', '2023-09-03 03:05:43'),
(19, 3, 6, '8 vCPU prod (4 vCPU Staging)', 3, 1, '2023-09-03 03:06:28', '2023-09-03 03:06:28'),
(20, 3, 6, '16 vCPU prod (8 vCPU Staging)', 4, 1, '2023-09-03 03:06:56', '2023-09-03 03:06:56');
...
--
-- Déchargement des données de la table `cron_jobs`
--
...
(1, 'Invoice Generate', 'invoice_generate', '[\"App\\\\Http\\\\Controllers\\\\CronController\", \"invoiceGenerate\"]', NULL, 3, '2023-08-31 04:29:02', '2023-08-31 04:14:02', 1, 1, '2023-06-21 23:29:14', '2023-08-31 04:14:02'),
(2, 'Remove Shopping Carts', 'remove_shopping_carts', '[\"App\\\\Http\\\\Controllers\\\\CronController\", \"removeShoppingCarts\"]', NULL, 3, '2023-08-31 04:29:02', '2023-08-31 04:14:02', 1, 1, '2023-06-22 06:04:49', '2023-08-31 04:14:02'),
(7, 'Unpaid Invoice Reminder', 'unpaid_invoice_reminder', '[\"App\\\\Http\\\\Controllers\\\\CronController\", \"unpaidInvoiceReminder\"]', NULL, 3, '2023-08-31 04:29:02', '2023-08-31 04:14:02', 1, 1, '2023-06-22 06:04:49', '2023-08-31 04:14:02'),
(8, 'First Overdue Reminder', 'first_overdue_reminder', '[\"App\\\\Http\\\\Controllers\\\\CronController\", \"firstOverdueReminder\"]', NULL, 3, '2023-08-31 04:29:02', '2023-08-31 04:14:02', 1, 1, '2023-06-22 06:04:49', '2023-08-31 04:14:02'),
(9, 'Second Overdue Reminder', 'second_overdue_reminder', '[\"App\\\\Http\\\\Controllers\\\\CronController\", \"secondOverdueReminder\"]', NULL, 3, '2023-08-31 04:29:02', '2023-08-31 04:14:02', 1, 1, '2023-06-22 06:04:49', '2023-08-31 04:14:02'),
(10, 'Third Overdue Reminder', 'third_overdue_reminder', '[\"App\\\\Http\\\\Controllers\\\\CronController\", \"thirdOverdueReminder\"]', NULL, 3, '2023-08-31 04:29:02', '2023-08-31 04:14:02', 1, 1, '2023-06-22 06:04:49', '2023-08-31 04:14:02'),
(11, 'Add Late Fee', 'add_late_fee', '[\"App\\\\Http\\\\Controllers\\\\CronController\", \"addLateFee\"]', NULL, 3, '2023-08-31 04:29:02', '2023-08-31 04:14:02', 1, 1, '2023-06-22 06:04:49', '2023-08-31 04:14:02');

-- --------------------------------------------------------

--
-- Structure de la table `cron_job_logs`
--
...
--
-- Déchargement des données de la table `cron_job_logs`
--

INSERT INTO `cron_job_logs` (`id`, `cron_job_id`, `start_at`, `end_at`, `duration`, `error`, `created_at`, `updated_at`) VALUES
(37, 1, '2023-08-31 04:14:02', '2023-08-31 04:14:02', 0, NULL, '2023-08-31 04:14:02', '2023-08-31 04:14:02'),
(38, 2, '2023-08-31 04:14:02', '2023-08-31 04:14:02', 0, NULL, '2023-08-31 04:14:02', '2023-08-31 04:14:02'),
(39, 7, '2023-08-31 04:14:02', '2023-08-31 04:14:02', 0, NULL, '2023-08-31 04:14:02', '2023-08-31 04:14:02'),
(40, 8, '2023-08-31 04:14:02', '2023-08-31 04:14:02', 0, NULL, '2023-08-31 04:14:02', '2023-08-31 04:14:02'),
(41, 9, '2023-08-31 04:14:02', '2023-08-31 04:14:02', 0, NULL, '2023-08-31 04:14:02', '2023-08-31 04:14:02'),
(42, 10, '2023-08-31 04:14:02', '2023-08-31 04:14:02', 0, NULL, '2023-08-31 04:14:02', '2023-08-31 04:14:02'),
(43, 11, '2023-08-31 04:14:02', '2023-08-31 04:14:02', 0, NULL, '2023-08-31 04:14:02', '2023-08-31 04:14:02');

-- --------------------------------------------------------

--
-- Structure de la table `cron_schedules`
--
...
--
-- Déchargement des données de la table `cron_schedules`
--
...
CREATE TABLE `domains` (
  ...
  `admin_notes` text COLLATE utf8mb4_unicode_ci COMMENT 'For admin only',
...
--
-- Structure de la table `domain_pricings`
--
...
--
-- Déchargement des données de la table `domain_pricings`
--

INSERT INTO `domain_pricings` (`id`, `domain_id`, `one_year_price`, `one_year_id_protection`, `one_year_renew`, `two_year_price`, `two_year_id_protection`, `two_year_renew`, `three_year_price`, `three_year_id_protection`, `three_year_renew`, `four_year_price`, `four_year_id_protection`, `four_year_renew`, `five_year_price`, `five_year_id_protection`, `five_year_renew`, `six_year_price`, `six_year_id_protection`, `six_year_renew`, `created_at`, `updated_at`) VALUES
(1, 1, '12000.0000000000000000', '1000.0000000000000000', '10000.0000000000000000', '10000.0000000000000000', '1500.0000000000000000', '8000.0000000000000000', '-1.0000000000000000', '0.0000000000000000', '0.0000000000000000', '-1.0000000000000000', '0.0000000000000000', '0.0000000000000000', '-1.0000000000000000', '0.0000000000000000', '0.0000000000000000', '-1.0000000000000000', '0.0000000000000000', '0.0000000000000000', '2023-09-02 00:50:06', '2023-09-02 00:51:52'),
(2, 2, '5000.0000000000000000', '2000.0000000000000000', '4000.0000000000000000', '4000.0000000000000000', '1000.0000000000000000', '3000.0000000000000000', '-1.0000000000000000', '0.0000000000000000', '0.0000000000000000', '-1.0000000000000000', '0.0000000000000000', '0.0000000000000000', '-1.0000000000000000', '0.0000000000000000', '0.0000000000000000', '-1.0000000000000000', '0.0000000000000000', '0.0000000000000000', '2023-09-02 00:53:32', '2023-09-02 00:55:25');

-- --------------------------------------------------------

--
-- Structure de la table `domain_registers`
--
...
--
-- Déchargement des données de la table `domain_registers`
--
...
--
-- Structure de la table `domain_setups`
--
...
--
-- Déchargement des données de la table `domain_setups`
--

INSERT INTO `domain_setups` (`id`, `extension`, `id_protection`, `status`, `created_at`, `updated_at`) VALUES
(1, '.bj', 1, 1, '2023-09-02 00:50:06', '2023-09-02 00:50:06'),
(2, '.com', 1, 1, '2023-09-02 00:53:32', '2023-09-02 00:53:32');
...
(27, 'contact_us.content', '{\"heading\":\"Get in Touch\",\"description\":\"Please do not hesitate to contact our experts if you want advise, have a query, or require technical support.\",\"email\":\"info@starlab.bj\",\"phone\":\"+22991299191\",\"address\":\"Abomey calavi, Benin\"}', '2020-10-28 00:59:19', '2023-08-31 16:24:46'),
...
(46, 'footer.content', '{\"description\":\"Cloud+ est Int\\u00e9grateur de solutions Cloud  qui vous accompagne dans la mise en place de vos environnements Cloud priv\\u00e9, public et hybride (SaaS, IaaS, PaaS\\u2026) et dans le choix, l\\u2019int\\u00e9gration et la maintenance de vos solutions d\\u2019h\\u00e9bergemen\"}', '2022-06-12 05:24:05', '2023-09-03 03:25:36'),
(48, 'domain.content', '{\"heading\":\"ACCELEREZ VOTRE PROJET, AUTOMATISEZ VOTRE INFRASTRUCTURE\",\"subheading\":\"\\ud83e\\udd47 Rapides & Flexibles VPS Cloud\",\"text\":\"\\u2705 CloudPlus vous offre une gamme \\u00e9tendue de solutions cloud, factur\\u00e9es sur la base d\'un paiement \\u00e0 l\'usage, et mises en place d\'une mani\\u00e8re simple qui soutient vos projets. Profitez de la flexibilit\\u00e9 des ressources \\u00e0 la demande pour passer de petits projets \\u00e0 des d\\u00e9ploiements \\u00e0 grande \\u00e9chelle.\"}', '2022-06-12 05:58:57', '2023-09-03 02:20:49'),
...
(57, 'subscribe.content', '{\"heading\":\"Me notifier\",\"subheading\":\"Recevoir des notifications pour les nouveaux messages\"}', '2023-01-22 14:23:01', '2023-09-03 03:43:19'),
...
(72, 'service.content', '{\"heading\":\"CHOISISSEZ VOTRE SERVICE CLOUD PR\\u00c9F\\u00c9R\\u00c9\",\"subheading\":\"___________________________\"}', '2023-09-02 03:29:36', '2023-09-02 15:38:28'),
(73, 'faq.element', '{\"question\":\"Qu\'est-ce qu\'un VPS et \\u00e0 quoi sert-il ?\",\"answer\":\"Un serveur priv\\u00e9 virtuel (VPS) permet d\\u2019h\\u00e9berger des sites web (vitrine, e-commerce, contenus, m\\u00e9dias) et des applications logicielles (portails, Extranet, solutions collaboratives, wikis, CRM). Contrairement \\u00e0 l\\u2019h\\u00e9bergement mutualis\\u00e9, les donn\\u00e9es sont isol\\u00e9es sur une machine virtuelle d\\u00e9di\\u00e9e \\u00e0 l\\u2019utilisateur.\\n\\nId\\u00e9alement situ\\u00e9s entre un h\\u00e9bergement web et un serveur physique, nos VPS conjuguent la fiabilit\\u00e9 et la performance d\\u2019un serveur d\\u00e9di\\u00e9 sans la gestion des contraintes mat\\u00e9rielles.\"}', '2023-09-03 03:38:19', '2023-09-03 03:38:19'),
(74, 'faq.element', '{\"question\":\"Que choisir entre VPS et h\\u00e9bergement web ?\",\"answer\":\"L\\u2019utilisation d\\u2019un VPS s\\u2019inscrit dans la continuit\\u00e9 logique de celle d\\u2019un h\\u00e9bergement web. Les serveurs priv\\u00e9s virtuels offrent davantage de possibilit\\u00e9s et une plus grande libert\\u00e9 d\\u2019action concernant le param\\u00e9trage, l\\u2019acc\\u00e8s et les fonctionnalit\\u00e9s (root, Apache PHP.init). Vous avez \\u00e9galement la possibilit\\u00e9 d\\u2019installer un certificat SSL ou tout autre logiciel de votre choix.\\n\\nNous attirons cependant votre attention sur la n\\u00e9cessit\\u00e9 de bien s\\u00e9lectionner votre VPS. En effet, celui-ci requiert une configuration conforme aux besoins des applications et une adaptation \\u00e0 la croissance de votre activit\\u00e9.\"}', '2023-09-03 03:38:49', '2023-09-03 03:38:49'),
(75, 'faq.element', '{\"question\":\"Qui peut se servir d\'un VPS ?\",\"answer\":\"G\\u00e9rer un VPS n\\u00e9cessite des connaissances de base en administration de serveurs. Ces notions sont essentielles pour g\\u00e9rer le syst\\u00e8me d\\u2019exploitation (Linux ou Windows) install\\u00e9 sur la machine et param\\u00e9trer les applications. Vous pensez avoir besoin d\\u2019un VPS, mais estimez ne pas poss\\u00e9der les comp\\u00e9tences requises ? Nous vous invitons \\u00e0 vous rapprocher de l\\u2019un de nos partenaires.\\n\\nSi vous souhaitez b\\u00e9n\\u00e9ficier de ressources garanties sans connaissances en administration de serveurs, nous vous conseillons nos h\\u00e9bergements web Performance.\"}', '2023-09-03 03:39:26', '2023-09-03 03:39:26'),
(76, 'faq.element', '{\"question\":\"Est-il possible d\'h\\u00e9berger plusieurs sites internet sur un VPS ?\",\"answer\":\"Oui. Un VPS peut \\u00eatre partitionn\\u00e9 et organis\\u00e9 en fonction de vos besoins. Vous pouvez ainsi y h\\u00e9berger plusieurs sites ou projets, en allouant \\u00e0 chacun un espace priv\\u00e9 dont vous choisissez le volume. Pour simplifier ces manipulations, vous avez la possibilit\\u00e9 d\'installer un panneau de gestion de sites web, comme Plesk ou cPanel.\"}', '2023-09-03 03:40:06', '2023-09-03 03:40:06');
...
CREATE TABLE `hostings` (
  ...
  `assigned_ips` text COLLATE utf8mb4_unicode_ci,
  `admin_notes` text COLLATE utf8mb4_unicode_ci COMMENT '	For admin only',
...
INSERT INTO `hostings` (`id`, `invoice`, `user_id`, `order_id`, `product_id`, `server_id`, `deposit_id`, `domain_setup_id`, `domain`, `package_name`, `first_payment_amount`, `recurring_amount`, `setup_fee`, `discount`, `status`, `billing_cycle`, `stock_control`, `username`, `password`, `ns1`, `ns2`, `ns3`, `ns4`, `ns1_ip`, `ns2_ip`, `ns3_ip`, `ns4_ip`, `dedicated_ip`, `ip`, `assigned_ips`, `admin_notes`, `suspend_reason`, `termination_date`, `suspend_date`, `next_due_date`, `next_invoice_date`, `reg_date`, `last_cron`, `created_at`, `updated_at`) VALUES
(1, 0, 1, 1, 1, 0, 0, 0, 'ere', NULL, '14000.000000000000000000', '12000.000000000000000000', '2000.00000000', '0.0000000000000000', 2, 1, 0, '', 'ere', 'ere', 'ere', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-10-03 04:17:07', '2023-09-23 04:17:07', '2023-09-03 04:17:07', NULL, '2023-09-03 04:17:07', '2023-09-03 04:18:49');

-- --------------------------------------------------------

--
-- Structure de la table `hosting_configs`
--
...
--
-- Déchargement des données de la table `hosting_configs`
--

INSERT INTO `hosting_configs` (`id`, `hosting_id`, `configurable_group_option_id`, `configurable_group_sub_option_id`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 1, NULL, NULL),
(2, 1, 3, 15, NULL, NULL),
(3, 1, 2, 16, NULL, NULL),
(4, 1, 4, 13, NULL, NULL);
...
CREATE TABLE `invoices` (
  ...
  `hosting_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `domain_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `reminder` text COLLATE utf8mb4_unicode_ci COMMENT 'An object/json for managing the invoice reminding notify process',
...
INSERT INTO `invoices` (`id`, `invoice_number`, `user_id`, `hosting_id`, `domain_id`, `reminder`, `amount`, `refund_amount`, `admin_notes`, `status`, `due_date`, `paid_date`, `next_due_date`, `created`, `last_cron`, `created_at`, `updated_at`) VALUES
(1, 500, 1, 0, 0, '{\"unpaid_reminder\":0,\"first_over_due_reminder\":0,\"second_over_due_reminder\":0,\"third_over_due_reminder\":0,\"add_late_fee\":0}', '14000.000000000000000000', '0.000000000000000000', NULL, 1, '2023-09-03 04:17:07', '2023-09-03 04:18:49', NULL, '2023-09-03 04:17:07', NULL, '2023-09-03 04:17:07', '2023-09-03 04:18:49');
...
INSERT INTO `invoice_items` (`id`, `invoice_id`, `user_id`, `hosting_id`, `domain_id`, `item_type`, `description`, `amount`, `tax`, `reg_period`, `trx_type`, `recurring_amount`, `next_due_date`, `created_at`, `updated_at`) VALUES
(1, 1, 1, 1, 0, 0, 'VPS 6-16 Setup Fee\nCloud VPS L', '2000.00000000', '0.00', 0, '+', '0.0000000000000000', NULL, '2023-09-03 04:17:07', '2023-09-03 04:17:07'),
(2, 1, 1, 1, 0, 0, 'VPS 6-16 - ere (03/09/2023 - 03/10/2023)\nCloud VPS L\nSTOCKAGE TYPE: 200 GB SSD\nIMAGE: Non - Merci\nAdd-Ons: Non - Merci\nSSL: SSL- INTEGRATION', '12000.00000000', '0.00', 0, '+', '0.0000000000000000', NULL, '2023-09-03 04:17:07', '2023-09-03 04:17:07');
...
(1, 'FRANÇAIS', 'fr_fr', 1, '2023-09-03 23:39:56', '2023-09-03 23:39:56');
...
--
-- Déchargement des données de la table `notification_logs`
--
...
(1, 1, 'php', 'info@viserlab.com', 'zimesongbian@gmail.com', 'Please verify your email address', '<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\">\r\n  <!--[if !mso]><!-->\r\n  <meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\">\r\n  <!--<![endif]-->\r\n  <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\r\n  <title></title>\r\n  <style type=\"text/css\">\r\n.ReadMsgBody { width: 100%; background-color: #ffffff; }\r\n.ExternalClass { width: 100%; background-color: #ffffff; }\r\n.ExternalClass, .ExternalClass p, .ExternalClass span, .ExternalClass font, .ExternalClass td, .ExternalClass div { line-height: 100%; }\r\nhtml { width: 100%; }\r\nbody { -webkit-text-size-adjust: none; -ms-text-size-adjust: none; margin: 0; padding: 0; }\r\ntable { border-spacing: 0; table-layout: fixed; margin: 0 auto;border-collapse: collapse; }\r\ntable table table { table-layout: auto; }\r\n.yshortcuts a { border-bottom: none !important; }\r\nimg:hover { opacity: 0.9 !important; }\r\na { color: #0087ff; text-decoration: none; }\r\n.textbutton a { font-family: \'open sans\', arial, sans-serif !important;}\r\n.btn-link a { color:#FFFFFF !important;}\r\n\r\n@media only screen and (max-width: 480px) {\r\nbody { width: auto !important; }\r\n*[class=\"table-inner\"] { width: 90% !important; text-align: center !important; }\r\n*[class=\"table-full\"] { width: 100% !important; text-align: center !important; }\r\n/* image */\r\nimg[class=\"img1\"] { width: 100% !important; height: auto !important; }\r\n}\r\n</style>\r\n\r\n\r\n\r\n  <table bgcolor=\"#414a51\" width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n    <tbody><tr>\r\n      <td height=\"50\"></td>\r\n    </tr>\r\n    <tr>\r\n      <td align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n        <table align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n          <tbody><tr>\r\n            <td align=\"center\" width=\"600\">\r\n              <!--header-->\r\n              <table class=\"table-inner\" width=\"95%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                <tbody><tr>\r\n                  <td bgcolor=\"#0087ff\" style=\"border-top-left-radius:6px; border-top-right-radius:6px;text-align:center;vertical-align:top;font-size:0;\" align=\"center\">\r\n                    <table width=\"90%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td align=\"center\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#FFFFFF; font-size:16px; font-weight: bold;\">This is a System Generated Email</td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n              </tbody></table>\r\n              <!--end header-->\r\n              <table class=\"table-inner\" width=\"95%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                <tbody><tr>\r\n                  <td bgcolor=\"#FFFFFF\" align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n                    <table align=\"center\" width=\"90%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"35\"></td>\r\n                      </tr>\r\n                      <!--logo-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"vertical-align:top;font-size:0;\">\r\n                          <a href=\"#\">\r\n                            <img style=\"display:block; line-height:0px; font-size:0px; border:0px;\" src=\"https://i.imgur.com/Z1qtvtV.png\" alt=\"img\">\r\n                          </a>\r\n                        </td>\r\n                      </tr>\r\n                      <!--end logo-->\r\n                      <tr>\r\n                        <td height=\"40\"></td>\r\n                      </tr>\r\n                      <!--headline-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"font-family: \'Open Sans\', Arial, sans-serif; font-size: 22px;color:#414a51;font-weight: bold;\">Hello   (zimesongbian)</td>\r\n                      </tr>\r\n                      <!--end headline-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n                          <table width=\"40\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                            <tbody><tr>\r\n                              <td height=\"20\" style=\" border-bottom:3px solid #0087ff;\"></td>\r\n                            </tr>\r\n                          </tbody></table>\r\n                        </td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                      <!--content-->\r\n                      <tr>\r\n                        <td align=\"left\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#7f8c8d; font-size:16px; line-height: 28px;\"><br><div><div style=\"font-family: Montserrat, sans-serif;\">Thanks For joining us.<br></div><div style=\"font-family: Montserrat, sans-serif;\">Please use the below code to verify your email address.<br></div><div style=\"font-family: Montserrat, sans-serif;\"><br></div><div style=\"font-family: Montserrat, sans-serif;\">Your email verification code is:<font size=\"6\"><span style=\"font-weight: bolder;\">&nbsp;278630</span></font></div></div></td>\r\n                      </tr>\r\n                      <!--end content-->\r\n                      <tr>\r\n                        <td height=\"40\"></td>\r\n                      </tr>\r\n              \r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n                <tr>\r\n                  <td height=\"45\" align=\"center\" bgcolor=\"#f4f4f4\" style=\"border-bottom-left-radius:6px;border-bottom-right-radius:6px;\">\r\n                    <table align=\"center\" width=\"90%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"10\"></td>\r\n                      </tr>\r\n                      <!--preference-->\r\n                      <tr>\r\n                        <td class=\"preference-link\" align=\"center\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#95a5a6; font-size:14px;\">\r\n                          © 2021 <a href=\"#\">CloudPlus</a>&nbsp;. All Rights Reserved. \r\n                        </td>\r\n                      </tr>\r\n                      <!--end preference-->\r\n                      <tr>\r\n                        <td height=\"10\"></td>\r\n                      </tr>\r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n              </tbody></table>\r\n            </td>\r\n          </tr>\r\n        </tbody></table>\r\n      </td>\r\n    </tr>\r\n    <tr>\r\n      <td height=\"60\"></td>\r\n    </tr>\r\n  </tbody></table>', 'email', '2023-09-01 03:49:28', '2023-09-01 03:49:28'),
(2, 1, 'php', 'info@viserlab.com', 'zimesongbian@gmail.com', 'Please verify your email address', '<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\">\r\n  <!--[if !mso]><!-->\r\n  <meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\">\r\n  <!--<![endif]-->\r\n  <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\r\n  <title></title>\r\n  <style type=\"text/css\">\r\n.ReadMsgBody { width: 100%; background-color: #ffffff; }\r\n.ExternalClass { width: 100%; background-color: #ffffff; }\r\n.ExternalClass, .ExternalClass p, .ExternalClass span, .ExternalClass font, .ExternalClass td, .ExternalClass div { line-height: 100%; }\r\nhtml { width: 100%; }\r\nbody { -webkit-text-size-adjust: none; -ms-text-size-adjust: none; margin: 0; padding: 0; }\r\ntable { border-spacing: 0; table-layout: fixed; margin: 0 auto;border-collapse: collapse; }\r\ntable table table { table-layout: auto; }\r\n.yshortcuts a { border-bottom: none !important; }\r\nimg:hover { opacity: 0.9 !important; }\r\na { color: #0087ff; text-decoration: none; }\r\n.textbutton a { font-family: \'open sans\', arial, sans-serif !important;}\r\n.btn-link a { color:#FFFFFF !important;}\r\n\r\n@media only screen and (max-width: 480px) {\r\nbody { width: auto !important; }\r\n*[class=\"table-inner\"] { width: 90% !important; text-align: center !important; }\r\n*[class=\"table-full\"] { width: 100% !important; text-align: center !important; }\r\n/* image */\r\nimg[class=\"img1\"] { width: 100% !important; height: auto !important; }\r\n}\r\n</style>\r\n\r\n\r\n\r\n  <table bgcolor=\"#414a51\" width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n    <tbody><tr>\r\n      <td height=\"50\"></td>\r\n    </tr>\r\n    <tr>\r\n      <td align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n        <table align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n          <tbody><tr>\r\n            <td align=\"center\" width=\"600\">\r\n              <!--header-->\r\n              <table class=\"table-inner\" width=\"95%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                <tbody><tr>\r\n                  <td bgcolor=\"#0087ff\" style=\"border-top-left-radius:6px; border-top-right-radius:6px;text-align:center;vertical-align:top;font-size:0;\" align=\"center\">\r\n                    <table width=\"90%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td align=\"center\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#FFFFFF; font-size:16px; font-weight: bold;\">This is a System Generated Email</td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n              </tbody></table>\r\n              <!--end header-->\r\n              <table class=\"table-inner\" width=\"95%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                <tbody><tr>\r\n                  <td bgcolor=\"#FFFFFF\" align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n                    <table align=\"center\" width=\"90%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"35\"></td>\r\n                      </tr>\r\n                      <!--logo-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"vertical-align:top;font-size:0;\">\r\n                          <a href=\"#\">\r\n                            <img style=\"display:block; line-height:0px; font-size:0px; border:0px;\" src=\"https://i.imgur.com/Z1qtvtV.png\" alt=\"img\">\r\n                          </a>\r\n                        </td>\r\n                      </tr>\r\n                      <!--end logo-->\r\n                      <tr>\r\n                        <td height=\"40\"></td>\r\n                      </tr>\r\n                      <!--headline-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"font-family: \'Open Sans\', Arial, sans-serif; font-size: 22px;color:#414a51;font-weight: bold;\">Hello   (zimesongbian)</td>\r\n                      </tr>\r\n                      <!--end headline-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n                          <table width=\"40\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                            <tbody><tr>\r\n                              <td height=\"20\" style=\" border-bottom:3px solid #0087ff;\"></td>\r\n                            </tr>\r\n                          </tbody></table>\r\n                        </td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                      <!--content-->\r\n                      <tr>\r\n                        <td align=\"left\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#7f8c8d; font-size:16px; line-height: 28px;\"><br><div><div style=\"font-family: Montserrat, sans-serif;\">Thanks For joining us.<br></div><div style=\"font-family: Montserrat, sans-serif;\">Please use the below code to verify your email address.<br></div><div style=\"font-family: Montserrat, sans-serif;\"><br></div><div style=\"font-family: Montserrat, sans-serif;\">Your email verification code is:<font size=\"6\"><span style=\"font-weight: bolder;\">&nbsp;556930</span></font></div></div></td>\r\n                      </tr>\r\n                      <!--end content-->\r\n                      <tr>\r\n                        <td height=\"40\"></td>\r\n                      </tr>\r\n              \r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n                <tr>\r\n                  <td height=\"45\" align=\"center\" bgcolor=\"#f4f4f4\" style=\"border-bottom-left-radius:6px;border-bottom-right-radius:6px;\">\r\n                    <table align=\"center\" width=\"90%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"10\"></td>\r\n                      </tr>\r\n                      <!--preference-->\r\n                      <tr>\r\n                        <td class=\"preference-link\" align=\"center\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#95a5a6; font-size:14px;\">\r\n                          © 2021 <a href=\"#\">CloudPlus</a>&nbsp;. All Rights Reserved. \r\n                        </td>\r\n                      </tr>\r\n                      <!--end preference-->\r\n                      <tr>\r\n                        <td height=\"10\"></td>\r\n                      </tr>\r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n              </tbody></table>\r\n            </td>\r\n          </tr>\r\n        </tbody></table>\r\n      </td>\r\n    </tr>\r\n    <tr>\r\n      <td height=\"60\"></td>\r\n    </tr>\r\n  </tbody></table>', 'email', '2023-09-01 03:51:52', '2023-09-01 03:51:52'),
(3, 1, 'php', 'info@viserlab.com', 'zimesongbian@gmail.com', 'Please verify your email address', '<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\">\r\n  <!--[if !mso]><!-->\r\n  <meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\">\r\n  <!--<![endif]-->\r\n  <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\r\n  <title></title>\r\n  <style type=\"text/css\">\r\n.ReadMsgBody { width: 100%; background-color: #ffffff; }\r\n.ExternalClass { width: 100%; background-color: #ffffff; }\r\n.ExternalClass, .ExternalClass p, .ExternalClass span, .ExternalClass font, .ExternalClass td, .ExternalClass div { line-height: 100%; }\r\nhtml { width: 100%; }\r\nbody { -webkit-text-size-adjust: none; -ms-text-size-adjust: none; margin: 0; padding: 0; }\r\ntable { border-spacing: 0; table-layout: fixed; margin: 0 auto;border-collapse: collapse; }\r\ntable table table { table-layout: auto; }\r\n.yshortcuts a { border-bottom: none !important; }\r\nimg:hover { opacity: 0.9 !important; }\r\na { color: #0087ff; text-decoration: none; }\r\n.textbutton a { font-family: \'open sans\', arial, sans-serif !important;}\r\n.btn-link a { color:#FFFFFF !important;}\r\n\r\n@media only screen and (max-width: 480px) {\r\nbody { width: auto !important; }\r\n*[class=\"table-inner\"] { width: 90% !important; text-align: center !important; }\r\n*[class=\"table-full\"] { width: 100% !important; text-align: center !important; }\r\n/* image */\r\nimg[class=\"img1\"] { width: 100% !important; height: auto !important; }\r\n}\r\n</style>\r\n\r\n\r\n\r\n  <table bgcolor=\"#414a51\" width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n    <tbody><tr>\r\n      <td height=\"50\"></td>\r\n    </tr>\r\n    <tr>\r\n      <td align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n        <table align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n          <tbody><tr>\r\n            <td align=\"center\" width=\"600\">\r\n              <!--header-->\r\n              <table class=\"table-inner\" width=\"95%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                <tbody><tr>\r\n                  <td bgcolor=\"#0087ff\" style=\"border-top-left-radius:6px; border-top-right-radius:6px;text-align:center;vertical-align:top;font-size:0;\" align=\"center\">\r\n                    <table width=\"90%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td align=\"center\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#FFFFFF; font-size:16px; font-weight: bold;\">This is a System Generated Email</td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n              </tbody></table>\r\n              <!--end header-->\r\n              <table class=\"table-inner\" width=\"95%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                <tbody><tr>\r\n                  <td bgcolor=\"#FFFFFF\" align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n                    <table align=\"center\" width=\"90%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"35\"></td>\r\n                      </tr>\r\n                      <!--logo-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"vertical-align:top;font-size:0;\">\r\n                          <a href=\"#\">\r\n                            <img style=\"display:block; line-height:0px; font-size:0px; border:0px;\" src=\"https://i.imgur.com/Z1qtvtV.png\" alt=\"img\">\r\n                          </a>\r\n                        </td>\r\n                      </tr>\r\n                      <!--end logo-->\r\n                      <tr>\r\n                        <td height=\"40\"></td>\r\n                      </tr>\r\n                      <!--headline-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"font-family: \'Open Sans\', Arial, sans-serif; font-size: 22px;color:#414a51;font-weight: bold;\">Hello   (zimesongbian)</td>\r\n                      </tr>\r\n                      <!--end headline-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n                          <table width=\"40\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                            <tbody><tr>\r\n                              <td height=\"20\" style=\" border-bottom:3px solid #0087ff;\"></td>\r\n                            </tr>\r\n                          </tbody></table>\r\n                        </td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                      <!--content-->\r\n                      <tr>\r\n                        <td align=\"left\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#7f8c8d; font-size:16px; line-height: 28px;\"><br><div><div style=\"font-family: Montserrat, sans-serif;\">Thanks For joining us.<br></div><div style=\"font-family: Montserrat, sans-serif;\">Please use the below code to verify your email address.<br></div><div style=\"font-family: Montserrat, sans-serif;\"><br></div><div style=\"font-family: Montserrat, sans-serif;\">Your email verification code is:<font size=\"6\"><span style=\"font-weight: bolder;\">&nbsp;148469</span></font></div></div></td>\r\n                      </tr>\r\n                      <!--end content-->\r\n                      <tr>\r\n                        <td height=\"40\"></td>\r\n                      </tr>\r\n              \r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n                <tr>\r\n                  <td height=\"45\" align=\"center\" bgcolor=\"#f4f4f4\" style=\"border-bottom-left-radius:6px;border-bottom-right-radius:6px;\">\r\n                    <table align=\"center\" width=\"90%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"10\"></td>\r\n                      </tr>\r\n                      <!--preference-->\r\n                      <tr>\r\n                        <td class=\"preference-link\" align=\"center\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#95a5a6; font-size:14px;\">\r\n                          © 2021 <a href=\"#\">CloudPlus</a>&nbsp;. All Rights Reserved. \r\n                        </td>\r\n                      </tr>\r\n                      <!--end preference-->\r\n                      <tr>\r\n                        <td height=\"10\"></td>\r\n                      </tr>\r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n              </tbody></table>\r\n            </td>\r\n          </tr>\r\n        </tbody></table>\r\n      </td>\r\n    </tr>\r\n    <tr>\r\n      <td height=\"60\"></td>\r\n    </tr>\r\n  </tbody></table>', 'email', '2023-09-01 03:54:17', '2023-09-01 03:54:17'),
(4, 1, 'php', 'info@viserlab.com', 'zimesongbian@gmail.com', 'Your Account has been Credited', '<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\">\r\n  <!--[if !mso]><!-->\r\n  <meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\">\r\n  <!--<![endif]-->\r\n  <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\r\n  <title></title>\r\n  <style type=\"text/css\">\r\n.ReadMsgBody { width: 100%; background-color: #ffffff; }\r\n.ExternalClass { width: 100%; background-color: #ffffff; }\r\n.ExternalClass, .ExternalClass p, .ExternalClass span, .ExternalClass font, .ExternalClass td, .ExternalClass div { line-height: 100%; }\r\nhtml { width: 100%; }\r\nbody { -webkit-text-size-adjust: none; -ms-text-size-adjust: none; margin: 0; padding: 0; }\r\ntable { border-spacing: 0; table-layout: fixed; margin: 0 auto;border-collapse: collapse; }\r\ntable table table { table-layout: auto; }\r\n.yshortcuts a { border-bottom: none !important; }\r\nimg:hover { opacity: 0.9 !important; }\r\na { color: #0087ff; text-decoration: none; }\r\n.textbutton a { font-family: \'open sans\', arial, sans-serif !important;}\r\n.btn-link a { color:#FFFFFF !important;}\r\n\r\n@media only screen and (max-width: 480px) {\r\nbody { width: auto !important; }\r\n*[class=\"table-inner\"] { width: 90% !important; text-align: center !important; }\r\n*[class=\"table-full\"] { width: 100% !important; text-align: center !important; }\r\n/* image */\r\nimg[class=\"img1\"] { width: 100% !important; height: auto !important; }\r\n}\r\n</style>\r\n\r\n\r\n\r\n  <table bgcolor=\"#414a51\" width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n    <tbody><tr>\r\n      <td height=\"50\"></td>\r\n    </tr>\r\n    <tr>\r\n      <td align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n        <table align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n          <tbody><tr>\r\n            <td align=\"center\" width=\"600\">\r\n              <!--header-->\r\n              <table class=\"table-inner\" width=\"95%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                <tbody><tr>\r\n                  <td bgcolor=\"#0087ff\" style=\"border-top-left-radius:6px; border-top-right-radius:6px;text-align:center;vertical-align:top;font-size:0;\" align=\"center\">\r\n                    <table width=\"90%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td align=\"center\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#FFFFFF; font-size:16px; font-weight: bold;\">This is a System Generated Email</td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n              </tbody></table>\r\n              <!--end header-->\r\n              <table class=\"table-inner\" width=\"95%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                <tbody><tr>\r\n                  <td bgcolor=\"#FFFFFF\" align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n                    <table align=\"center\" width=\"90%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"35\"></td>\r\n                      </tr>\r\n                      <!--logo-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"vertical-align:top;font-size:0;\">\r\n                          <a href=\"#\">\r\n                            <img style=\"display:block; line-height:0px; font-size:0px; border:0px;\" src=\"https://i.imgur.com/Z1qtvtV.png\" alt=\"img\">\r\n                          </a>\r\n                        </td>\r\n                      </tr>\r\n                      <!--end logo-->\r\n                      <tr>\r\n                        <td height=\"40\"></td>\r\n                      </tr>\r\n                      <!--headline-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"font-family: \'Open Sans\', Arial, sans-serif; font-size: 22px;color:#414a51;font-weight: bold;\">Hello zime songbian (zimesongbian)</td>\r\n                      </tr>\r\n                      <!--end headline-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n                          <table width=\"40\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                            <tbody><tr>\r\n                              <td height=\"20\" style=\" border-bottom:3px solid #0087ff;\"></td>\r\n                            </tr>\r\n                          </tbody></table>\r\n                        </td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                      <!--content-->\r\n                      <tr>\r\n                        <td align=\"left\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#7f8c8d; font-size:16px; line-height: 28px;\"><div><div style=\"font-family: Montserrat, sans-serif;\">50,000.00 CFA has been added to your account .</div><div style=\"font-family: Montserrat, sans-serif;\"><br></div><div style=\"font-family: Montserrat, sans-serif;\">Transaction Number : OO2JTDUCKRDP</div><div style=\"font-family: Montserrat, sans-serif;\"><br></div><span style=\"color: rgb(33, 37, 41); font-family: Montserrat, sans-serif;\">Your Current Balance is :&nbsp;</span><font style=\"font-family: Montserrat, sans-serif;\"><span style=\"font-weight: bolder;\">50,000.00&nbsp; CFA&nbsp;</span></font><br></div><div><font style=\"font-family: Montserrat, sans-serif;\"><span style=\"font-weight: bolder;\"><br></span></font></div><div>Admin note:&nbsp;<span style=\"color: rgb(33, 37, 41); font-size: 12px; font-weight: 600; white-space: nowrap; text-align: var(--bs-body-text-align);\">for test</span></div></td>\r\n                      </tr>\r\n                      <!--end content-->\r\n                      <tr>\r\n                        <td height=\"40\"></td>\r\n                      </tr>\r\n              \r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n                <tr>\r\n                  <td height=\"45\" align=\"center\" bgcolor=\"#f4f4f4\" style=\"border-bottom-left-radius:6px;border-bottom-right-radius:6px;\">\r\n                    <table align=\"center\" width=\"90%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"10\"></td>\r\n                      </tr>\r\n                      <!--preference-->\r\n                      <tr>\r\n                        <td class=\"preference-link\" align=\"center\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#95a5a6; font-size:14px;\">\r\n                          © 2021 <a href=\"#\">STAR-LAB /CloudPlus</a>&nbsp;. All Rights Reserved. \r\n                        </td>\r\n                      </tr>\r\n                      <!--end preference-->\r\n                      <tr>\r\n                        <td height=\"10\"></td>\r\n                      </tr>\r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n              </tbody></table>\r\n            </td>\r\n          </tr>\r\n        </tbody></table>\r\n      </td>\r\n    </tr>\r\n    <tr>\r\n      <td height=\"60\"></td>\r\n    </tr>\r\n  </tbody></table>', 'email', '2023-09-03 04:18:17', '2023-09-03 04:18:17'),
(5, 1, 'php', 'info@viserlab.com', 'zimesongbian@gmail.com', 'New Order Notification', '<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\">\r\n  <!--[if !mso]><!-->\r\n  <meta http-equiv=\"X-UA-Compatible\" content=\"IE=edge\">\r\n  <!--<![endif]-->\r\n  <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\r\n  <title></title>\r\n  <style type=\"text/css\">\r\n.ReadMsgBody { width: 100%; background-color: #ffffff; }\r\n.ExternalClass { width: 100%; background-color: #ffffff; }\r\n.ExternalClass, .ExternalClass p, .ExternalClass span, .ExternalClass font, .ExternalClass td, .ExternalClass div { line-height: 100%; }\r\nhtml { width: 100%; }\r\nbody { -webkit-text-size-adjust: none; -ms-text-size-adjust: none; margin: 0; padding: 0; }\r\ntable { border-spacing: 0; table-layout: fixed; margin: 0 auto;border-collapse: collapse; }\r\ntable table table { table-layout: auto; }\r\n.yshortcuts a { border-bottom: none !important; }\r\nimg:hover { opacity: 0.9 !important; }\r\na { color: #0087ff; text-decoration: none; }\r\n.textbutton a { font-family: \'open sans\', arial, sans-serif !important;}\r\n.btn-link a { color:#FFFFFF !important;}\r\n\r\n@media only screen and (max-width: 480px) {\r\nbody { width: auto !important; }\r\n*[class=\"table-inner\"] { width: 90% !important; text-align: center !important; }\r\n*[class=\"table-full\"] { width: 100% !important; text-align: center !important; }\r\n/* image */\r\nimg[class=\"img1\"] { width: 100% !important; height: auto !important; }\r\n}\r\n</style>\r\n\r\n\r\n\r\n  <table bgcolor=\"#414a51\" width=\"100%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n    <tbody><tr>\r\n      <td height=\"50\"></td>\r\n    </tr>\r\n    <tr>\r\n      <td align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n        <table align=\"center\" border=\"0\" cellpadding=\"0\" cellspacing=\"0\">\r\n          <tbody><tr>\r\n            <td align=\"center\" width=\"600\">\r\n              <!--header-->\r\n              <table class=\"table-inner\" width=\"95%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                <tbody><tr>\r\n                  <td bgcolor=\"#0087ff\" style=\"border-top-left-radius:6px; border-top-right-radius:6px;text-align:center;vertical-align:top;font-size:0;\" align=\"center\">\r\n                    <table width=\"90%\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td align=\"center\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#FFFFFF; font-size:16px; font-weight: bold;\">This is a System Generated Email</td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n              </tbody></table>\r\n              <!--end header-->\r\n              <table class=\"table-inner\" width=\"95%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                <tbody><tr>\r\n                  <td bgcolor=\"#FFFFFF\" align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n                    <table align=\"center\" width=\"90%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"35\"></td>\r\n                      </tr>\r\n                      <!--logo-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"vertical-align:top;font-size:0;\">\r\n                          <a href=\"#\">\r\n                            <img style=\"display:block; line-height:0px; font-size:0px; border:0px;\" src=\"https://i.imgur.com/Z1qtvtV.png\" alt=\"img\">\r\n                          </a>\r\n                        </td>\r\n                      </tr>\r\n                      <!--end logo-->\r\n                      <tr>\r\n                        <td height=\"40\"></td>\r\n                      </tr>\r\n                      <!--headline-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"font-family: \'Open Sans\', Arial, sans-serif; font-size: 22px;color:#414a51;font-weight: bold;\">Hello zime songbian (zimesongbian)</td>\r\n                      </tr>\r\n                      <!--end headline-->\r\n                      <tr>\r\n                        <td align=\"center\" style=\"text-align:center;vertical-align:top;font-size:0;\">\r\n                          <table width=\"40\" border=\"0\" align=\"center\" cellpadding=\"0\" cellspacing=\"0\">\r\n                            <tbody><tr>\r\n                              <td height=\"20\" style=\" border-bottom:3px solid #0087ff;\"></td>\r\n                            </tr>\r\n                          </tbody></table>\r\n                        </td>\r\n                      </tr>\r\n                      <tr>\r\n                        <td height=\"20\"></td>\r\n                      </tr>\r\n                      <!--content-->\r\n                      <tr>\r\n                        <td align=\"left\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#7f8c8d; font-size:16px; line-height: 28px;\"><p><strong style=\"font-size: 0.875rem; text-align: var(--bs-body-text-align);\">Order Information</strong><br></p><p>Order ID: 1<br>Date/Time: <br>Invoice Id: 1<br>Amount: 14,000.00</p><p><br></p><p><strong>Customer Information</strong></p><p>Name: zime songbian<br>Email: zimesongbian@gmail.com<br>Address: Abomey calavi<br>City: Calavi<br>State: Atlantique<br>Postcode: 00229<br>Country: Benin<br>Phone Number: 22991299191</p><p><br></p><p><strong>Order Items</strong></p><p>VPS 6-16 Setup Fee<br/>Cloud VPS L<br>VPS 6-16 - ere (03/09/2023 - 03/10/2023)<br/>Cloud VPS L<br/>STOCKAGE TYPE: 200 GB SSD<br/>IMAGE: Non - Merci<br/>Add-Ons: Non - Merci<br/>SSL: SSL- INTEGRATION<br></p><p><br></p><p><strong>ISP Information</strong></p><p>IP: 137.255.40.117<br></p><p><br></p><p>\n</td>\r\n                      </tr>\r\n                      <!--end content-->\r\n                      <tr>\r\n                        <td height=\"40\"></td>\r\n                      </tr>\r\n              \r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n                <tr>\r\n                  <td height=\"45\" align=\"center\" bgcolor=\"#f4f4f4\" style=\"border-bottom-left-radius:6px;border-bottom-right-radius:6px;\">\r\n                    <table align=\"center\" width=\"90%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\r\n                      <tbody><tr>\r\n                        <td height=\"10\"></td>\r\n                      </tr>\r\n                      <!--preference-->\r\n                      <tr>\r\n                        <td class=\"preference-link\" align=\"center\" style=\"font-family: \'Open sans\', Arial, sans-serif; color:#95a5a6; font-size:14px;\">\r\n                          © 2021 <a href=\"#\">STAR-LAB /CloudPlus</a>&nbsp;. All Rights Reserved. \r\n                        </td>\r\n                      </tr>\r\n                      <!--end preference-->\r\n                      <tr>\r\n                        <td height=\"10\"></td>\r\n                      </tr>\r\n                    </tbody></table>\r\n                  </td>\r\n                </tr>\r\n              </tbody></table>\r\n            </td>\r\n          </tr>\r\n        </tbody></table>\r\n      </td>\r\n    </tr>\r\n    <tr>\r\n      <td height=\"60\"></td>\r\n    </tr>\r\n  </tbody></table>', 'email', '2023-09-03 04:18:49', '2023-09-03 04:18:49');
...
INSERT INTO `orders` (`id`, `invoice_id`, `coupon_id`, `user_id`, `amount`, `discount`, `after_discount`, `ip_address`, `admin_notes`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 0, 1, '14000.000000000000000000', '0.00000000', '14000.00000000', '137.255.40.117', 'Merci pour l\'achat', 1, '2023-09-03 04:17:07', '2023-09-03 04:21:30');
...
INSERT INTO `pricings` (`id`, `type`, `product_id`, `configurable_group_sub_option_id`, `monthly_setup_fee`, `quarterly_setup_fee`, `semi_annually_setup_fee`, `annually_setup_fee`, `biennially_setup_fee`, `triennially_setup_fee`, `monthly`, `quarterly`, `semi_annually`, `annually`, `biennially`, `triennially`, `created_at`, `updated_at`) VALUES
(1, 'sub_config_options', 0, 1, '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '2000.00000000', '8000.00000000', '11000.00000000', '20000.00000000', '35000.00000000', '50000.00000000', '2023-09-02 00:30:13', '2023-09-02 04:18:55'),
(2, 'product', 1, 0, '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '10000.00000000', '-1.00000000', '-1.00000000', '10000.00000000', '-1.00000000', '-1.00000000', '2023-09-02 00:35:46', '2023-09-03 02:48:16'),
(3, 'product', 2, 0, '1000.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '10000.00000000', '-1.00000000', '-1.00000000', '110000.00000000', '-1.00000000', '-1.00000000', '2023-09-02 03:55:10', '2023-09-03 02:53:13'),
(4, 'sub_config_options', 0, 2, '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '5000.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '2023-09-02 04:24:15', '2023-09-02 04:24:15'),
(5, 'sub_config_options', 0, 3, '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '2023-09-02 04:26:04', '2023-09-02 04:26:04'),
(6, 'sub_config_options', 0, 4, '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '3000.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '2023-09-02 04:26:33', '2023-09-02 04:28:03'),
(7, 'sub_config_options', 0, 5, '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '2023-09-02 04:48:12', '2023-09-02 04:48:12'),
(8, 'sub_config_options', 0, 6, '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '2023-09-02 04:48:39', '2023-09-02 04:48:39'),
(9, 'sub_config_options', 0, 7, '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '2023-09-02 04:49:03', '2023-09-02 04:49:03'),
(10, 'sub_config_options', 0, 8, '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '2023-09-02 04:49:33', '2023-09-02 04:49:33'),
(11, 'sub_config_options', 0, 9, '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '2023-09-02 04:50:14', '2023-09-02 04:50:14'),
(12, 'sub_config_options', 0, 10, '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '2023-09-02 04:54:38', '2023-09-02 04:54:38'),
(13, 'sub_config_options', 0, 11, '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '2023-09-02 04:55:30', '2023-09-02 04:55:30'),
(14, 'sub_config_options', 0, 12, '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '2023-09-02 04:56:01', '2023-09-02 04:56:01'),
(15, 'sub_config_options', 0, 13, '2000.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '2023-09-02 04:58:50', '2023-09-02 04:58:50'),
(16, 'sub_config_options', 0, 14, '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '2023-09-02 04:59:47', '2023-09-02 05:00:35'),
(17, 'sub_config_options', 0, 15, '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '2023-09-02 05:01:00', '2023-09-02 05:01:00'),
(18, 'sub_config_options', 0, 16, '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '2023-09-02 05:01:25', '2023-09-02 05:01:25'),
(19, 'product', 3, 0, '10.00000000', '0.00000000', '0.00000000', '5000.00000000', '0.00000000', '0.00000000', '50000.00000000', '-1.00000000', '-1.00000000', '200000.00000000', '-1.00000000', '-1.00000000', '2023-09-02 05:11:07', '2023-09-03 02:53:29'),
(20, 'product', 4, 0, '2000.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '7000.00000000', '-1.00000000', '-1.00000000', '50000.00000000', '-1.00000000', '-1.00000000', '2023-09-02 05:19:55', '2023-09-03 02:52:54'),
(21, 'product', 5, 0, '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '5000.00000000', '-1.00000000', '-1.00000000', '8.00000000', '-1.00000000', '-1.00000000', '2023-09-02 16:19:42', '2023-09-03 03:01:48'),
(22, 'sub_config_options', 0, 17, '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '10000.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '2023-09-03 03:05:19', '2023-09-03 03:05:19'),
(23, 'sub_config_options', 0, 18, '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '12000.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '2023-09-03 03:05:43', '2023-09-03 03:09:00'),
(24, 'sub_config_options', 0, 19, '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '13000.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '2023-09-03 03:06:28', '2023-09-03 03:06:28'),
(25, 'sub_config_options', 0, 20, '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '15000.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '0.00000000', '2023-09-03 03:06:56', '2023-09-03 03:06:56');
...
INSERT INTO `products` (`id`, `category_id`, `server_group_id`, `server_id`, `package_name`, `product_type`, `payment_type`, `module_type`, `module_option`, `name`, `slug`, `description`, `welcome_email`, `domain_register`, `stock_control`, `stock_quantity`, `status`, `created_at`, `updated_at`) VALUES
(1, 1, 0, 0, NULL, 3, 2, 0, 3, 'VPS 6-16', 'vps-6-16', '________________________\r\n✅ <font size=\"5\" face=\"Cambria, Bold\" color=\"blue\">Ressources</font>\r\n________________________\r\n&#10102 - 2 Cores CPU @ 2.6 GHz \r\n________________________\r\n&#10103 - 6 Go RAM DDR4 ECC \r\n________________________\r\n&#10104 - 80 Go Disque SSD \r\n________________________\r\n&#10105 - 100 Mbps Internet \r\n________________________\r\n&#10106 - 1 adresse IPv4 \r\n________________________\r\n&#10107 - Protection Anti-DDoS Arbor \r\n________________________\r\n✅ <font size=\"5\" face=\"Cambria, Bold\" color=\"blue\">Fonctionnalités</font>\r\n________________________\r\n&#10108 - Panel : OxaPanel\r\n_________________________\r\n&#10109 - Sites Web : Unlimited\r\n_________________________\r\n&#10110 - Comptes FTP : Unlimited\r\n_________________________\r\n&#10111 - Emails : Unlimited\r\n_________________________\r\n&#10111 - Bases de données MySQL : Unlimited', 3, 0, 0, 10, 1, '2023-09-02 00:35:46', '2023-09-03 02:46:27'),
(2, 3, 0, 0, NULL, 4, 2, 0, 3, 'Cloud VPS S', 'cloud-vps-s', '________________________\r\n✅ <font size=\"5\" face=\"Cambria, Bold\" color=\"blue\">Ressources</font>\r\n________________________\r\n&#10102 - 2 Cores CPU @ 2.6 GHz \r\n________________________\r\n&#10103 - 6 Go RAM DDR4 ECC \r\n________________________\r\n&#10104 - 80 Go Disque SSD \r\n________________________\r\n&#10105 - 100 Mbps Internet \r\n________________________\r\n&#10106 - 1 adresse IPv4 \r\n________________________\r\n&#10107 - Protection Anti-DDoS Arbor \r\n________________________\r\n✅ <font size=\"5\" face=\"Cambria, Bold\" color=\"blue\">Fonctionnalités</font>\r\n________________________\r\n&#10108 - Panel : OxaPanel\r\n_________________________\r\n&#10109 - Sites Web : Unlimited\r\n_________________________\r\n&#10110 - Comptes FTP : Unlimited\r\n_________________________\r\n&#10111 - Emails : Unlimited\r\n_________________________\r\n&#10111 - Bases de données MySQL : Unlimited', 1, 0, 0, 0, 1, '2023-09-02 03:55:10', '2023-09-03 02:53:13'),
(3, 4, 0, 0, NULL, 2, 2, 0, 3, 'Cloud VPS XL', 'cloud-vps-xl', '________________________\r\n✅ <font size=\"5\" face=\"Cambria, Bold\" color=\"blue\">Ressources</font>\r\n________________________\r\n&#10102 - 2 Cores CPU @ 2.6 GHz \r\n________________________\r\n&#10103 - 6 Go RAM DDR4 ECC \r\n________________________\r\n&#10104 - 80 Go Disque SSD \r\n________________________\r\n&#10105 - 100 Mbps Internet \r\n________________________\r\n&#10106 - 1 adresse IPv4 \r\n________________________\r\n&#10107 - Protection Anti-DDoS Arbor \r\n________________________\r\n✅ <font size=\"5\" face=\"Cambria, Bold\" color=\"blue\">Fonctionnalités</font>\r\n________________________\r\n&#10108 - Panel : OxaPanel\r\n_________________________\r\n&#10109 - Sites Web : Unlimited\r\n_________________________\r\n&#10110 - Comptes FTP : Unlimited\r\n_________________________\r\n&#10111 - Emails : Unlimited\r\n_________________________\r\n&#10111 - Bases de données MySQL : Unlimited', 0, 0, 0, 0, 1, '2023-09-02 05:11:07', '2023-09-03 02:53:29'),
(4, 2, 0, 0, NULL, 2, 2, 0, 3, 'Cloud VPS M', 'cloud-vps-m', '________________________\r\n✅ <font size=\"5\" face=\"Cambria, Bold\" color=\"blue\">Ressources</font>\r\n________________________\r\n&#10102 - 2 Cores CPU @ 2.6 GHz \r\n________________________\r\n&#10103 - 6 Go RAM DDR4 ECC \r\n________________________\r\n&#10104 - 80 Go Disque SSD \r\n________________________\r\n&#10105 - 100 Mbps Internet \r\n________________________\r\n&#10106 - 1 adresse IPv4 \r\n________________________\r\n&#10107 - Protection Anti-DDoS Arbor \r\n________________________\r\n✅ <font size=\"5\" face=\"Cambria, Bold\" color=\"blue\">Fonctionnalités</font>\r\n________________________\r\n&#10108 - Panel : OxaPanel\r\n_________________________\r\n&#10109 - Sites Web : Unlimited\r\n_________________________\r\n&#10110 - Comptes FTP : Unlimited\r\n_________________________\r\n&#10111 - Emails : Unlimited\r\n_________________________\r\n&#10111 - Bases de données MySQL : Unlimited', 0, 0, 0, 0, 1, '2023-09-02 05:19:55', '2023-09-03 02:52:54'),
(5, 6, 0, 0, NULL, 4, 1, 0, 3, 'Web PaaS', 'web-paas', '________________________\r\n✅ <font size=\"5\" face=\"Cambria, Bold\" color=\"blue\">Ressources</font>\r\n________________________\r\nNous prenons en charge la mise en service, l’hébergement et la gestion de votre plateforme pour un usage en ligne immédiat.\r\n________________________\r\n✅ <font size=\"5\" face=\"Cambria, Bold\" color=\"blue\">Fonctionnalités</font>\r\n________________________\r\n&#10102 - environnement de production\r\n_________________________\r\n&#10103 - environnement de test\r\n_________________________\r\n&#10104 - 10 Go stockage extensible\r\n_________________________\r\n&#10105 - licences utilisateur incluses (Jusqu\'à 100 max)\r\n_________________________\r\n&#10106 - Sauvegarde automatique\r\n_________________________\r\n&#10107 - Sauvegarde automatique\r\n_________________________\r\n&#10108 - Certificat Let\'s Encrypt\r\n_________________________\r\n&#10109 - 2 vCPU prod (1 vCPU Staging) \r\n_________________________\r\n&#10110 - 4 vCPU prod (2 vCPU Staging)\r\n_________________________\r\n&#10111 - 8 vCPU prod (4 vCPU Staging) \r\n_________________________\r\n&#10112 - 16 vCPU prod (8 vCPU Staging)\r\n_________________________', 0, 0, 0, 0, 1, '2023-09-02 16:19:42', '2023-09-03 03:00:57');

-- --------------------------------------------------------

--
-- Structure de la table `product_configurations`
--
...
--
-- Déchargement des données de la table `product_configurations`
--

INSERT INTO `product_configurations` (`id`, `configurable_group_id`, `product_id`, `created_at`, `updated_at`) VALUES
(1, 1, 1, NULL, NULL),
(2, 1, 2, NULL, NULL),
(3, 1, 3, NULL, NULL),
(4, 1, 4, NULL, NULL),
...
(3, 'staff_starlab', '2023-08-31 15:40:49', '2023-08-31 15:40:49');
...
--
-- Structure de la table `server_groups`
--
...
--
-- Déchargement des données de la table `server_groups`
--

INSERT INTO `server_groups` (`id`, `name`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Cloud VPS servers', 1, '2023-09-02 00:31:27', '2023-09-02 00:31:27');
...
INSERT INTO `service_categories` (`id`, `name`, `slug`, `short_description`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Cloud VPS L', 'cloud-vps-l', 'Les plans vCPU partagés présentent le meilleur rapport qualité-prix. Ils conviennent aux environnements de développement et de production avec des niveaux moyens de trafic et de demande réseau.', 1, '2023-08-31 05:31:02', '2023-09-02 05:41:54'),
(2, 'Cloud VPS M', 'cloud-vps-m', 'Repensez votre cloud ! Essayez une alternative aux serveurs en nuage basés sur x86. Découvrez l\'architecture Arm64 puissante et durable à un prix stupéfiant.', 1, '2023-09-02 00:26:54', '2023-09-02 05:24:04'),
(3, 'CLOUD VPS S', 'cloud-vps-s', 'Meilleur rapport qualité-prix. Convient aux sites web et aux applications à faible et moyen trafic, qui peuvent supporter des niveaux variables d\'allocation du CPU.', 1, '2023-09-02 03:52:23', '2023-09-02 03:52:23'),
(4, 'Cloud VPS XL', 'cloud-vps-xl', 'Idéal pour les applications critiques et les charges de travail avec une utilisation élevée et continue de l\'unité centrale et du réseau. Vous bénéficiez d\'une faible latence et de performances prévisibles.', 1, '2023-09-02 05:09:01', '2023-09-02 05:09:01'),
(5, 'Solutions de bureau à distance', 'desktop-remote', 'Accédez à des bureaux distants et à des applications professionnelles depuis n\'importe quel endroit et n\'importe quel appareil.', 1, '2023-09-02 06:04:33', '2023-09-02 06:04:33'),
(6, 'Web PaaS', 'web-paas', 'Concentrez-vous sur le code ! Nous nous occupons du reste.\r\nNotre plateforme automatisée, flexible et entièrement gérée « as a service » permet aux développeurs web de déployer leur code source avec Git dans n’importe quel langage ou framework, sans avoir besoin de connaissances en gestion de serveur.', 1, '2023-09-02 16:09:27', '2023-09-03 00:47:03');
...
INSERT INTO `shopping_carts` (`id`, `domain_register_id`, `user_id`, `domain_id`, `product_id`, `domain_setup_id`, `coupon_id`, `type`, `id_protection`, `reg_period`, `billing_cycle`, `domain`, `hostname`, `ns1`, `ns2`, `ns3`, `ns4`, `password`, `price`, `setup_fee`, `discount_applied`, `coupon_type`, `coupon_discount`, `discount`, `total`, `after_discount`, `config_options`, `created_at`, `updated_at`) VALUES
(4, NULL, 1605032382, 0, 2, 0, 0, 1, 0, 0, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '15000.0000000000000000', '1000.0000000000000000', 0, 0, '0.00000000', '0.0000000000000000', '16000.0000000000000000', '16000.0000000000000000', '{\"1\":\"2\",\"3\":\"6\",\"2\":\"11\",\"4\":\"14\"}', '2023-09-03 05:44:16', '2023-09-03 05:44:16');
...
INSERT INTO `transactions` (`id`, `invoice_id`, `user_id`, `amount`, `charge`, `post_balance`, `trx_type`, `trx`, `details`, `remark`, `created_at`, `updated_at`) VALUES
(1, 0, 1, '50000.00000000', '0.00000000', '50000.00000000', '+', 'OO2JTDUCKRDP', 'for test', 'balance_add', '2023-09-03 04:18:17', '2023-09-03 04:18:17'),
(2, 1, 1, '14000.00000000', '0.00000000', '36000.00000000', '-', 'G2HM442Y4C85', 'Payment', NULL, '2023-09-03 04:18:49', '2023-09-03 04:18:49');
...
INSERT INTO `users` (`id`, `firstname`, `lastname`, `username`, `email`, `country_code`, `mobile`, `ref_by`, `balance`, `password`, `address`, `status`, `kyc_data`, `kv`, `ev`, `sv`, `profile_complete`, `ver_code`, `ver_code_send_at`, `ts`, `tv`, `tsc`, `ban_reason`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'zime', 'songbian', 'zimesongbian', 'zimesongbian@gmail.com', 'BJ', '22991299191', 0, '36000.00000000', '$2y$10$YCDFn6NVbvV.Ty0fSKj9J.3AvyUCkX1Co6B9887JJJzWH1751ItaW', '{\"country\":\"Benin\",\"address\":\"Abomey calavi\",\"state\":\"Atlantique\",\"zip\":\"00229\",\"city\":\"Calavi\"}', 1, NULL, 1, 1, 1, 1, NULL, NULL, 0, 1, NULL, NULL, NULL, '2023-09-01 03:49:27', '2023-09-03 04:18:49');
...
(1, 1, '41.85.176.155', 'Ouidah', 'Benin', 'BJ', '2.0899', '6.3589', 'Safari', 'Mac OS X', '2023-09-01 03:49:27', '2023-09-01 03:49:27'),
(2, 1, '137.255.40.117', '', 'Benin', 'BJ', '2.25', '9.5', 'Chrome', 'Mac OS X', '2023-09-03 04:16:34', '2023-09-03 04:16:34');
...
--
-- Index pour la table `billing_settings`
--
ALTER TABLE `billing_settings`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `cancel_requests`
--
ALTER TABLE `cancel_requests`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `configurable_groups`
--
ALTER TABLE `configurable_groups`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `configurable_group_options`
--
ALTER TABLE `configurable_group_options`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `configurable_group_sub_options`
--
...
--
-- Index pour la table `cron_job_logs`
--
ALTER TABLE `cron_job_logs`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `cron_schedules`
--
...
--
-- Index pour la table `domain_pricings`
--
ALTER TABLE `domain_pricings`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `domain_registers`
--
ALTER TABLE `domain_registers`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `domain_setups`
--
...
--
-- Index pour la table `hosting_configs`
--
...
--
-- Index pour la table `product_configurations`
--
...
--
-- Index pour la table `server_groups`
--
...
--
-- AUTO_INCREMENT pour la table `billing_settings`
--
ALTER TABLE `billing_settings`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `cancel_requests`
--
ALTER TABLE `cancel_requests`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `configurable_groups`
--
ALTER TABLE `configurable_groups`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT pour la table `configurable_group_options`
--
ALTER TABLE `configurable_group_options`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT pour la table `configurable_group_sub_options`
--
ALTER TABLE `configurable_group_sub_options`
...
--
-- AUTO_INCREMENT pour la table `cron_job_logs`
--
ALTER TABLE `cron_job_logs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=44;

--
-- AUTO_INCREMENT pour la table `cron_schedules`
--
ALTER TABLE `cron_schedules`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT pour la table `domain_pricings`
--
ALTER TABLE `domain_pricings`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT pour la table `domain_registers`
--
ALTER TABLE `domain_registers`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT pour la table `domain_setups`
--
ALTER TABLE `domain_setups`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT pour la table `hosting_configs`
--
ALTER TABLE `hosting_configs`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT pour la table `product_configurations`
--
ALTER TABLE `product_configurations`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
-- AUTO_INCREMENT pour la table `server_groups`
--
ALTER TABLE `server_groups`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- AUTO_INCREMENT pour la table `shopping_carts`
--
ALTER TABLE `shopping_carts`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
